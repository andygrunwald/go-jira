...
func TestIssueService_Get_Success(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/rest/agile/1.0/issue/10002", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "GET")
		testRequestURL(t, r, "/rest/agile/1.0/issue/10002")
...
func TestIssueService_Get_WithQuerySuccess(t *testing.T) {
	...
	testMux.HandleFunc("/rest/agile/1.0/issue/10002", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "GET")
		testRequestURL(t, r, "/rest/agile/1.0/issue/10002?expand=foo")
