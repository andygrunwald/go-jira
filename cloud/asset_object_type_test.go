...
func TestAssetsObjectTypeService_Get(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23")
	...
	if objectType, err := testClient.Assets.ObjectType.Get(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "23"); err != nil {
...
func TestAssetsObjectTypeService_Update(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23", func(w http.ResponseWriter, r *http.Request) {
	...
	if object, err := testClient.Assets.ObjectType.Update(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "23", assets.PutObjectType{}); err != nil {
		t.Errorf("Error given: %s", err)
	} else if object == nil {
...
func TestAssetsObjectTypeService_Delete(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23", func(w http.ResponseWriter, r *http.Request) {
...
func TestAssetsObjectTypeService_UpdatePosition(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/position", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/position")
		fmt.Fprint(w, `{"workspaceId":"g2778e1d-939d-581d-c8e2-9d5g59de456b","globalId":"g2778e1d-939d-581d-c8e2-9d5g59de456b:23","id":"23","name":"Office","description":"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec ex.","icon":{"id":"13","name":"Building","url16":"https://api.atlassian.com/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/icon.png?size=16","url48":"https://api.atlassian.com/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/icon.png?size=48"},"position":2,"created":"2021-02-16T19:36:51.951Z","updated":"2021-04-16T15:17:03.384Z","objectCount":4,"objectSchemaId":"6","inherited":false,"abstractObjectType":false,"parentObjectTypeInherited":false}`)
	})
	if objectType, err := testClient.Assets.ObjectType.UpdatePosition(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "23", assets.PostObjectTypePosition{}); err != nil {
		t.Errorf("Error given: %s", err)
	} else if objectType == nil {
		t.Error("Expected objectType. Object is nil")
	}
...
func TestAssetsObjectTypeService_Create(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/create", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/create")
		fmt.Fprint(w, `{"workspaceId":"g2778e1d-939d-581d-c8e2-9d5g59de456b","globalId":"g2778e1d-939d-581d-c8e2-9d5g59de456b:23","id":"23","name":"Office","description":"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec ex.","icon":{"id":"13","name":"Building","url16":"https://api.atlassian.com/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/icon.png?size=16","url48":"https://api.atlassian.com/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objecttype/23/icon.png?size=48"},"position":2,"created":"2021-02-16T19:36:51.951Z","updated":"2021-04-16T15:17:03.384Z","objectCount":4,"objectSchemaId":"6","inherited":false,"abstractObjectType":false,"parentObjectTypeInherited":false}`)
	})
	if objectType, err := testClient.Assets.ObjectType.Create(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", assets.CreateObjectType{}); err != nil {
		t.Errorf("Error given: %s", err)
	} else if objectType == nil {
		t.Error("Expected objectType. Object is nil")
	}
