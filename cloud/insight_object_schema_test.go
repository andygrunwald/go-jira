...
func TestInsightObjectSchemaService_GetAttributes(t *testing.T) {
	...
	if history, err := testClient.Insight.ObjectSchema.GetAttributes(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "13", &insight.ObjectSchemaAttributeOptions{
		OnlyValueEditable: true,
		Extended:          true,
	}); err != nil {
		t.Errorf("Error given: %s", err)
	} else if history == nil {
		t.Error("Expected history. Object is nil")
	}
}
