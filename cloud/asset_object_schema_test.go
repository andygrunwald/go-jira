...
func TestAssetsObjectSchemaService_List(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/list", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/list")
	...
	if objectSchemas, err := testClient.Assets.ObjectSchema.List(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b"); err != nil {
...
func TestAssetsObjectSchemaService_Create(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/create", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/create")
	...
	if objectSchema, err := testClient.Assets.ObjectSchema.Create(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", assets.CreateOrUpdateObjectSchema{}); err != nil {
		t.Errorf("Error given: %s", err)
...
func TestAssetsObjectSchemaService_Get(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/39", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		testRequestURL(t, r, "/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/39")
		fmt.Fprint(w, `{"workspaceId":"g2778e1d-939d-581d-c8e2-9d5g59de456b","globalId":"g2778e1d-939d-581d-c8e2-9d5g59de456b:39","id":"39","name":"Computers","objectSchemaKey":"COMP","status":"Ok","description":"The IT department schema","created":"2021-04-20T16:21:18.908Z","updated":"2021-04-20T16:21:18.912Z","objectCount":0,"objectTypeCount":0,"idAsInt":39}`)
	})
	if objectSchema, err := testClient.Assets.ObjectSchema.Get(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "39"); err != nil {
		t.Errorf("Error given: %s", err)
	} else if objectSchema == nil {
		t.Error("Expected objectSchema. Object is nil")
	}
...
func TestAssetsObjectSchemaService_Update(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/39", func(w http.ResponseWriter, r *http.Request) {
	...
	if objectSchema, err := testClient.Assets.ObjectSchema.Update(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "39", assets.CreateOrUpdateObjectSchema{}); err != nil {
		t.Errorf("Error given: %s", err)
	} else if objectSchema == nil {
		t.Error("Expected objectSchema. Object is nil")
	}
...
func TestAssetsObjectSchemaService_Delete(t *testing.T) {
	setup()
	defer teardown()
	testMux.HandleFunc("/jsm/assets/workspace/g2778e1d-939d-581d-c8e2-9d5g59de456b/v1/objectschema/39", func(w http.ResponseWriter, r *http.Request) {
	...
	if objectSchema, err := testClient.Assets.ObjectSchema.Delete(context.Background(), "g2778e1d-939d-581d-c8e2-9d5g59de456b", "39"); err != nil {
		t.Errorf("Error given: %s", err)
	} else if objectSchema == nil {
		t.Error("Expected objectSchema. Object is nil")
	}
